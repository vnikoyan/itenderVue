...
jQuery(function ($) {
    ...
    $('.progress .progress-bar').progressbar({
        display_text: 'center', percent_format: function (p) {
            return p + ' %';
        }
    });
    ...
    $("#forgot-btn1").on('click', function (e) {
        $('#login-content').show();
        $('#forgot-content').hide();
        e.preventDefault();
    ...
    $('.pricing-table-content__slider').each(function () {
        $(this).slick({
            dots: false,
            infinite: true,
            speed: 500,
    ...
    $('.pricing-pet-table-content__slider').each(function () {
        console.error(this);
        $(this).slick({
            dots: true,
            infinite: true,
    ...
    $('.pricing-pet-table-content__slider2').each(function () {
        console.error(this);
        $(this).slick({
            dots: true,
            infinite: true,
    ...
    $('.latest-news-content__sider').each(function () {
        $(this).slick({
            dots: false,
            infinite: true,
            speed: 500,
    ...
    $('.latest-news-content__sider_1').each(function () {
        $(this).slick({
            dots: false,
            infinite: true,
            speed: 500,
