<template>
    <div class="card" :class="open ? 'opened' : ''">
      <div class="card-header">
        <button @click="() => open = !open" class="d-flex w-100 justify-content-between align-items-center" type="button" data-toggle="collapse" data-target="#organisationSettingsCollapse" aria-expanded="false" aria-controls="organisationSettingsCollapse">
          <h4 data-target="#organisationSettingsCollapse" aria-expanded="false" aria-controls="organisationSettingsCollapse" class="mb-0">Կազմակերպության տվյալներ</h4>
          ...
          <span v-tooltip="'Կազմակերպության տվյալները փոփոխելու հնարավորություն ունի միայն համակարգողը'" v-if="!isCoordinator">
            <i class="fas fa-question-circle"></i>
          </span>
        </button>
      </div>
      <div id="organisationSettingsCollapse" class="collapse multi-collapse">
              ...
              <form class="form-parsley" :key="type">
                ...
                <div class="form-row">
                  <div class="col-md-6 mb-4 px-md-2">
                    <float-label class="text-secondary" >
                      <input
                ...
                <div v-else>
                  <div class="form-row">
                    <div class="col-md-6 mb-4 px-md-2">
                      <float-label :dispatch="false" class="w-100">
                        <input
                          :disabled="!isCoordinator && $v.fields.name.hy.$model"
                          v-model="$v.fields.name.hy.$model"
                    ...
                    <div class="col-md-6 mb-4 px-md-2">
                      <float-label :dispatch="false" class="w-100">
                        <input
                          :disabled="!isCoordinator && $v.fields.name.ru.$model !==''"
                          v-model="$v.fields.name.ru.$model"
                          type="text"
                          name="company_name_ru"
                          class="auth-input mb-0"
                ...
                <div v-if="type === 'legalEntity'">
                  ...
                  <div class="form-row">
                    <div class="col-md-6 mb-3 px-md-3">
                      <label>{{$t('state_customer.pl_name_surname')}}</label>
                      <input
                        v-if="isPrivate"
                        :disabled="!isCoordinator"
                        id="director-name-hy"
                    ...
                    <div class="col-md-6 mb-3 px-md-3">
                      <label>{{$t('state_customer.pl_name_surname_rus')}}</label>
                      <input
                        v-if="isPrivate"
                        :disabled="!isCoordinator"
                        id="director-name-ru"
                  ...
                  <div v-if="!isPrivate" class="form-row">
                    <div class="col-md-6 mb-3 px-md-3">
                      <label>{{$t('state_customer.pl_position')}}</label>
                      <input
                        id="director-name-hy"
                        v-model="$v.fields.director_position.hy.$model"
                        :placeholder="$t('state_customer.pl_position')"
                        type="text"
                        name="director_position"
                        class="auth-input form-control"
                        :class="{'border-danger': isInvalidField('director_position.hy', 'required')}"
                      />
                      <div v-if="isInvalidField('director_position.hy', 'required')"
                        class="small text-danger">
                        {{ $t('state_customer.valid_1') }}
                      </div>
                    </div>
                    <div class="col-md-6 mb-3 px-md-3">
                      <label>{{$t('state_customer.pl_position_rus')}}</label>
                      <input
                        id="director-name-ru"
                        v-model="$v.fields.director_position.ru.$model"
                        :placeholder="$t('state_customer.pl_position_rus')"
                        type="text"
                        name="director_position"
                        class="auth-input form-control"
                        :class="{'border-danger': isInvalidField('director_position.ru', 'required')}"
                      />
                      <div v-if="isInvalidField('director_position.ru', 'required')"
                        class="small text-danger">
                        {{ $t('state_customer.valid_1') }}
                      </div>
                    </div>
...
export default {
  ...
  watch: {
    me(newValue, oldValue) {
      ...
      this.fields.director_position.hy = this.me.organisation[0].translations.director_position.hy;
      this.fields.director_position.ru = this.me.organisation[0].translations.director_position.ru;
  ...
  mounted(){
    if(this.me.organisation){
      this.fields.name = this.me.organisation[0].translations.name;
      ...
      this.fields.region = this.me.organisation[0].translations.region;
      this.fields.city = this.me.organisation[0].translations.city;
      this.fields.address = this.me.organisation[0].translations.address;
      this.fields.bank_name = this.me.organisation[0].translations.bank_name;
      this.fields.director_name = this.me.organisation[0].translations.director_name;
      this.fields.director_position = this.me.organisation[0].translations.director_position;
      this.fields.company_type = this.me.organisation[0].translations.company_type;
    }
  },
  computed: {
    isCoordinator(){
  ...
  methods: {
    ...
    save() {
      if(!this.$v.fields.$invalid) {
        $client.put(`organisation`, this.fields).then(({data}) => {
          if(data){
            this.$notify({
              group: 'foo',
              type: 'success',
