                  ...
                  >
                    <div slot="beforeTable" class="padding-20 pb-0 text-center text-md-left">
                      <div class="d-inline-block tab-block">
                        <ul class="nav nav-tabs align-items-end suggestions-tab-mobile" id="myTab" role="tablist">
                          <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#active" @click.prevent="$router.push('/participant/contract-management/orders/active')" role="tab" aria-controls="home" aria-selected="true">
                              Ընթացիկ
                            </a>
                          </li>
                          <li class="nav-item" role="presentation">
                    ...
                    <div slot="invoice_details" class="d-flex justify-content-start align-items-center h-100" slot-scope="{row}">
                      <div class="row align-items-center justify-left m-0 p-0">
                        <div class='col-12 p-0 mb-2 text-center'>
                          {{row.is_full ? ' Դուրս գրված է' : 'Դուրս գրված չէ' }}
                        </div>
                    ...
                    <div slot="docs" slot-scope="{row}">
                      <div class="row align-items-center justify-left m-0 p-0">
                        ...
                        <div v-if="row.contract.organize_type !== 'itender'" class='col-12 p-0 mb-2 text-primary text-left'>
                          <button
      ...
      return {
        ...
        options: {
          ...
          headings: {
            ...
            status: 'Կարգավիճակ',
            invoice_details: 'Հաշիվ ապրանքագիր',
            docs: 'Փաստաթղթեր',
          },
          filterable: false
        },
