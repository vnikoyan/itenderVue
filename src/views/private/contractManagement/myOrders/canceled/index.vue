                  ...
                  <div slot="beforeTable" class="padding-20 pb-0 text-center text-md-left">
                    <div class="d-inline-block tab-block">
                      <ul class="nav nav-tabs align-items-end suggestions-tab-mobile" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                          <a class="nav-link active" id="contact-tab" data-toggle="tab" href="#canceled" @click.prevent="$router.push('/organizator/contract-management/orders/canceled')" role="tab" aria-controls="contact" aria-selected="false">
                            Չկատարված
                          </a>
                        </li>
                      </ul>
