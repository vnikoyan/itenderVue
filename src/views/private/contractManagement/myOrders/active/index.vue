              ...
              <div class="col-12 tenders-list p-0">
                ...
                >
                  <div slot="beforeTable" class="padding-20 pb-0 text-center text-md-left">
                    <div class="d-inline-block tab-block">
                      <ul class="nav nav-tabs align-items-end suggestions-tab-mobile" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                          <a class="nav-link active" id="home-tab" data-toggle="tab" href="#active" @click.prevent="$router.push('/organizator/contract-management/orders/active')" role="tab" aria-controls="home" aria-selected="true">
                            Ընթացիկ
                          </a>
                        </li>
                        <li class="nav-item" role="presentation">
                          <a class="nav-link" id="profile-tab" data-toggle="tab" href="#finished" @click.prevent="$router.push('/organizator/contract-management/orders/finished')" role="tab" aria-controls="profile" aria-selected="false">
                            Ավարտված
                          </a>
                        </li>
                        <li class="nav-item" role="presentation">
                  ...
                  <div slot="invoice_details" class="d-flex justify-content-start align-items-center h-100" slot-scope="{row}">
                    {{row.invoice_number !== '' ? ' Դուրս գրված է' : 'Դուրս գրված չէ' }}
                  </div>
