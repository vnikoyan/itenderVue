        ...
        <section slot="pdf-content" contenteditable="true">
            <div class="col-md-12">
                <div class="info-block">
                    ...
                    <br>
                    <h6 style="margin-top: 3rem; text-align: center; font-weight: 700">ՊԵՏՈՒԹՅԱՆ ԿԱՐԻՔՆԵՐԻ ՀԱՄԱՐ ԾԱՌԱՅՈՒԹՅՈՒՆՆԵՐԻ ՄԱՏՈՒՑՄԱՆ ՊԵՏԱԿԱՆ ԳՆՄԱՆ ՊԱՅՄԱՆԱԳԻՐ</h6>
                ...
                <div class="info-block">
                    ...
                    <h6 style="margin-bottom: 0; margin-top: 0; text-align: justify"> 
                        <span style="margin-left: 25px;"/>1.1 Պատվիրատուն հանձնարարում է, իսկ Կատարողը ստանձնում է 
                        <editor-input onkeypress="this.style.width = ((this.value.length + 1) * 10 + 5) + 'px';" type="text" inputName="work_names" ref="work_names" v-model="$v.inputs.work_names.$model" />
                ...
                <div class="info-block">
                    ...
                    <h6 style="margin-bottom: 30px; margin-top: 0;text-align: justify">
                        <span style="margin-left: 25px;"/>2.2.1 Քննարկել և ընդունել Տեխնիկական բնութագիր-գնման ժամանակացույցին համապատասխան մատուցված ծառայության արդյունքը, իսկ ծառայության արդյունքում թերություններ հայտնաբերելու դեպքերում` այդ մասին անհապաղ գրավոր հայտնել Կատարողին։
                    ...
                    <h6 style="margin-bottom: 30px; margin-top: 0;text-align: justify">
                        <span style="margin-left: 25px;"/>2.4.1 Պայմանագրի N 1 հավելվածով սահմանված պայմաններով ապահովել ծառայության մատուցումը` ղեկավարվելով գործող օրենսդրությամբ։
                ...
                <div class="info-block">
                    <p style="font-weight: 700; text-align: center;">3. ԾԱՌԱՅՈՒԹՅԱՆ ՀԱՆՁՆՄԱՆ ԵՎ ԸՆԴՈՒՆՄԱՆ ԿԱՐԳԸ</p>
                    <h6 style="margin-bottom: 30px; margin-top: 0; text-align: justify">
                        <template v-if="+currentOrganized.organize_type === 1">
                                ...
                                <br/><span style="margin-left: 25px;"/>3.2 Եթե մատուցված ծառայությունը համապատասխանում է պայմանագրի պայմաններին, Պատվիրատուն պայմանագրի 3.1 կետում նշված փաստաթղթերը ստանալու օրվան հաջորդող աշխատանքային օրվանից հաշված
                                <input type="text"
                                    class="editor-input"
                                ...
                                <br/><span style="margin-left: 25px;"/>3.4 Եթե պայմանագրի 3.2 կետով սահմանված ժամկետում Պատվիրատուն չի ընդունում մատուցված ծառայությունը կամ չի մերժում դրա ընդունումը, ապա մատուցված ծառայությունը համարվում է ընդունված և պայմանագրի 3.2 կետով սահման­ված վերջնաժամկետին հաջորդող աշխատանքային օրը Պատվիրատուն  էլեկտրոնային գնումների համակարգի միջոցով Կատարողին է տրամադրում իր կողմից ստորագրված հանձնման-ընդունման արձանա­գրությունը:
                        </template>
                        <template v-else>
                                <span style="margin-left: 25px;"/>3.1 Մատուցված ծառայությունն ընդունվում է Պատվիրատուի և Կատարողի միջև հանձնման-ընդունման արձանագրության ստորագրմամբ: Ծառայությունը Պատվիրատուին հանձնելու փաստը ֆիքսվում է Պատվիրատուի և Կատարողի միջև երկկողմ հաստատված փաստաթղթով՝ նշելով փաստաթղթի կազմման ամսաթիվը:
                                <br/><span style="margin-left: 25px;"/>
                                Մինչև պայմանագրով ծառայության մատուցման համար նախատեսված օրը ներառյալ Կատարողը Պատվիրատուին է տրամադրում իր կողմից ստորագրված` ծառայությունը Պատվիրատուին հանձնելու փաստը ֆիքսող փաստաթուղթը (հավելված N 3.1) և հանձնման-ընդունման արձանագրության 
                                <input type="text"
                                ...
                                <br/><span style="margin-left: 25px;"/>3.4. Եթե պայմանագրի 3.3 կետով սահմանված ժամկետում Պատվիրատուն չի ընդունում մատուցված ծառայությունը կամ չի մերժում դրա ընդունումը, ապա մատուցված ծառայությունը համարվում է ընդունված և պայմանագրի 3.3 կետով սահման­ված վերջնաժամկետին հաջորդող աշխատանքային օրը Պատվիրատուն   Կատարողին է տրամադրում իր կողմից հաստատված հանձնման-ընդունման արձանա­գրությունը:
                        </template>
                    </h6>
                </div>
                <div class="info-block">
                    <p style="font-weight: 700; text-align: center;">4. ՊԱՅՄԱՆԱԳՐԻ ԳԻՆԸ</p>
                    <h6 style="margin-bottom: 30px; margin-top: 0; text-align: justify">
                ...
                <div class="info-block">
                    <p style="font-weight: 700; text-align: center;">5. ԿՈՂՄԵՐԻ ՊԱՏԱՍԽԱՆԱՏՎՈՒԹՅՈՒՆԸ</p>
                    <h6 style="margin-bottom: 30px; margin-top: 0; text-align: justify">
                        ...
                        <template v-if="!currentOrganized.is_with_condition">
                            Պայմանագրի N 1 հավելվածում նշված տեխնիկական բնութագրին չհամապատասխանող ծառայություն մատուցելու յուրաքանչյուր դեպքում Կատարողից գանձվում է տուգանք` պայմանագրի 4.1 կետում նախատեսված գումարի 0,5 (զրո ամբողջ հինգ տասնորդական) տոկոսի չափով:
                        </template>
                        <template v-else>
                            Եթե պայմանագիրը կնքվել է «Գնումների մասին» ՀՀ օրենքի 15-րդ հոդվածի 6-րդ կետի հիման վրա, ապա տուգանքը հաշվարկվում է այն համաձայնագրի գնի նկատմամբ, որի շրջանակում արձանագրվել է ստանձնված պարտավորությունների չկատարման կամ ոչ պատշաճ կատարման հանգամանքը:
                            <br/><span style="margin-left: 25px;"/>Եթե պայմանագիրը ներառում է մեկից ավել չափաբաժին, ապա տուգանքը հաշվարկվում է պայմանագրով այդ չափաբաժնի համար սահմանված ընդհանուր գնի նկատմամբ:
                        </template>
                        Ընդ որում տուգանքը հաշվարկվում է նաև ծառայությունը սույն պայմանագրով սահմանված ժամկետում մատուցելու, սակայն պատվիրատուի կողմից այդ չընդունվելու դեպքում:
                ...
                <div class="info-block">
                    <p style="font-weight: 700; text-align: center;">6. ԱՆՀԱՂԹԱՀԱՐԵԼԻ ՈՒԺԻ ԱԶԴԵՑՈՒԹՅՈՒՆ (ՖՈՐՍ-ՄԱԺՈՐ)</p>
                    <h6 style="margin-bottom: 30px; margin-top: 0; text-align: justify">
                ...
                <div class="info-block">
                    <p style="font-weight: 700; text-align: center;">7. ԱՅԼ ՊԱՅՄԱՆՆԵՐ</p>
                    <h6 style="margin-bottom: 30px; margin-top: 0; text-align: justify">
                                ...
                                <tr>
                                    <td style="border:none !important;">
                                        <div style="text-align: right">                       
                                            <h6 class="ft-11" style="text-align: left; font-weight: 700">ՊԱՏՎԻՐԱՏՈՒ</h6>
                                            <p class="ft-11" style="font-size: 14px; text-align: left">« {{ me.organisation[0].translations.name.hy }} » {{ me.organisation[0].translations.company_type.hy }}</p>
                                            <p class="ft-11" style="font-size: 14px; text-align: left" v-if="me.organisation[0].translations.region.hy === me.organisation[0].translations.city.hy"> {{ me.organisation[0].translations.city.hy }} {{ me.organisation[0].translations.address.hy }}</p>
                                            <p class="ft-11" style="font-size: 14px; text-align: left" v-else>{{ me.organisation[0].translations.region.hy }}  {{ me.organisation[0].translations.city.hy }} {{ me.organisation[0].translations.address.hy }}</p>
                                            <p class="ft-11" style="font-size: 14px; text-align: left">Բանկ՝ {{ me.organisation[0].translations.bank_name.hy }}</p>
                                            <p class="ft-11" style="font-size: 14px; text-align: left">Հ/Հ {{ me.organisation[0].bank_account }} </p>
                                            <p class="ft-11" style="font-size: 14px; text-align: left">ՀՎՀՀ {{ me.organisation[0].tin }} </p>
                                            <p class="ft-11" style="font-size: 14px; text-align: left">{{ me.organisation[0].translations.director_position.hy }}՝ {{ me.organisation[0].translations.director_name.hy }}</p>
                                    ...
                                    <td>
                                        <div style="padding: 80px; text-align: left">
                                            <h6 class="ft-11" style="text-align: left; font-weight: 700">ԿԱՏԱՐՈՂ</h6>
                ...
                <div class="info-block">
                    ...
                    <h6 style="text-align: justify;">
                        <span style="color: rgb(17, 85, 204);">** Եթե պայմանագիրը կնքվում է "Գնումների մասին" ՀՀ օրենքի 15-րդ հոդվածի 6-րդ մասի հիման վրա, ապա սյունակում ժամկետի հաշվարկն իրականացվում է ֆինանսական միջոցներ նախատեսվելու դեպքում կողմերի միջև կնքվող համաձայնագրի ուժի մեջ մտնելու օրվանից սկսած:</span>
                    </h6>
                    <div class="info-block" style="padding: 60px 0">
                        <table style="width: 100%; border: none !important">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div style="text-align: left; padding-left: 80px">
                                            <h6 class="ft-11" style="text-align: left; font-weight: 700">ԿԱՏԱՐՈՂ</h6>
                                            <p class="ft-11" style="font-size: 14px; text-align: left;">« <span class="winner-name">______________</span> » <span class="winner-type">_______</span></p>
                                            <p class="ft-11" style="font-size: 14px; text-align: left;"><span class="winner-address">_____________________</span></p>
                                            <p class="ft-11" style="font-size: 14px; text-align: left;">Բանկ՝<span class="winner-bank">___________</span></p>
                                            <p class="ft-11" style="font-size: 14px; text-align: left;">Հ/Հ <span class="winner-bank_account">_____________________</span></p>
                                            <p class="ft-11" style="font-size: 14px; text-align: left;">ՀՎՀՀ <span class="winner-tin">______________</span></p>
                ...
                <div class="info-block">
                    ...
                    <div style="text-align: right; font-weight: 700"><span class="contract-code" style="color: rgb(17, 85, 204);"></span> ծածկագրով գնման պայմանագրի</div>
                    <br class="page-break"/>
                    <h6 style="text-align: center; font-weight: 700">ՎՃԱՐՄԱՆ ԺԱՄԱՆԱԿԱՑՈՒՅՑ*</h6>
                    <table style="font-size: 10px; 
                            width: 100%;
                            table-layout: fixed;
                            border-collapse: collapse;
                ...
                <div class="info-block">
                    ...
                    <h6 style="text-align: left;">
                        Պայմանագրի շրջանակներում Պայմանագրի կողմը  կատարել է հետևյալ ծառայությունները՝
                    </h6>
                    <table style="font-size: 10px;
                                width: 100%;
                                table-layout: fixed;
                        ...
                        <table style="width: 100%; border: none !important">
                            <tbody style="width: 100%">
                                <tr>
                                    <td>
                                        <div style="text-align: right">
                                            <h6 class="ft-11">Ծառայությունը հանձնեց&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                                    ...
                                    <td>
                                        <div style="text-align: left; padding-left: 80px">
                                            <h6 class="ft-11">Ծառայությունը ընդունեց&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                                            <h6>__________________________________</h6>
                                            <h6>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ստորագրություն</h6>
                                            <h6>__________________________________</h6>
                                            <h6>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ազգանուն, անուն</h6>
                ...
                <div class="info-block">
                    ...
                    <h6 style="text-align: center">Սույնով արձանագրվում է, որ   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -ի (այսուհետ` Պատվիրատու)   և   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 	        -ի</h6>	
                    <p style="font-size: 14px; text-align: center">Պատվիրատուի անունը   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Կատարողի անունը</p>
                    <h6 style="text-align: center">
                        (այսուհետ` Կատարող) միջև 20&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;թ.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-ին կնքված N 
                    </h6>
                    <p style="font-size: 14px; text-align: center">	պայմանագրի կնքման ամսաթիվը  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; պայմանագրի համարը
                    </p>
                    <h6 style="text-align: center">
                        գնման պայմանագրի շրջանակներում Կատարողը  20&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; թ. -ին հանձնման-ընդունման նպատակով			
                    </h6>
                    <h6 style="text-align: center">Պատվիրատուին հանձնեց ստորև նշված ծառայությունները.</h6>
                    <table style=" 
                            width: 100%;
                            table-layout: fixed;
                            border-collapse: collapse;
