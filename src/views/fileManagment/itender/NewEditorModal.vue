        ...
        <div id="modal-body">
            <div class="h-100">
                <component
                    ...
                    :lng="lng"
                />
                <div id="commandment-file" v-show="false" ref="contract" class="w-100 h-100">
                    <vue-html2pdf
                        id="document"
                        v-show="false"
...
export default {
    ...
    components: {
        ...
        report: () => import('./secondStep/report'),
    ...
    methods: {
        ...
        async downloadPDF() {
            ...
            if(this.currentFile === 'report'){
                this.$client
                .post(`organize/itender/report/${this.$route.params.id}`, {
                    report_document: this.content,
                })
                .then(({ status, data }) => {
                    if (data.data) {
                        this.$store.commit(
