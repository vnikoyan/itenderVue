<template>
	...
	>
		...
		<h6 :style="newProps ? 'font-size: 11pt' : ''" style="text-align: justify;font-family: GHEA grapalat ;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1) բավարարում է « <span style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{ password }}</span> »  ծածկագրով  <span :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{getTenderTypeByPlan}}</span> հրավերով սահմանված մասնակցության իրավունքի պահանջներին  և պարտավորվում ընտրված մասնակից ճանաչվելու դեպքում, հրավերով սահմանված կարգով և ժամկետում, ներկայացնել  որակավորման ապահովում. </h6>
		<h6 :style="newProps ? 'font-size: 11pt' : ''" style="text-align: justify;font-family: GHEA grapalat ;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2) « <span :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{ password }}</span> » ծածկագրով <span :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{getTenderTypeByPlan}}</span> մասնակցելու շրջանակում`</h6>
		...
		<div v-if="is_new_beneficiari === false">
			<h6 :style="newProps ? 'font-size: 11pt' : ''" style="text-align: justify; font-family: GHEA grapalat ;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ստորև ներկայացնում է հայտը ներկայացնելու օրվա դրությամբ այն ֆիզիկական անձի (անձանց) տվյալները, ով ուղղակի կամ անուղղակի ունի մասնակցի կանոնադրական կապիտալում քվեարկող բաժնետոմսերի (բաժնեմասերի, փայերի) ավել քան տաս տոկոսը, ներառյալ ըստ ներկայացնողի բաժնետոմսերը, կամ այն անձի (անձանց) տվյալները, ով իրավունք ունի նշանակելու կամ ազատելու մասնակցի գործադիր մարմնի անդամներին, կամ ստանում է մասնակցի կողմից իրականացվող ձեռնարկատիրական կամ այլ գործունեության արդյունքում ստացված շահույթի տասնհինգ տոկոսից ավելին (իրական շահառուներ) և հավաստում, որ իրական շահառուների մասին ներկայացված տեղեկատվությունը իրական է և չի պարունակում ոչ հավսատի տեղեկություններ: 
			</h6>
		</div>

		<div v-if="is_new_beneficiari">
			<h6 :style="newProps ? 'font-size: 11pt' : ''" style="margin: 30px 0;font-family: GHEA grapalat ;">Ստորև ներկայացնում է <span :style="newProps ? 'font-size: 11pt' : ''" style="font-family: GHEA grapalat ; color: rgb(17, 85, 204)">«{{ participantInfo.name.hy }}» {{ participantInfo.company_type.hy }}</span>-ի իրական շահառուների վերաբերյալ</h6>
			<h6 :style="newProps ? 'font-size: 11pt' : ''" v-if="beneficiaries.inputOptions === 1" style="font-family: GHEA grapalat ;">տեղեկություններ պարունակող կայքէջի հղումը՝ <a style="font-family: GHEA grapalat ;" :style="newProps ? 'font-size: 11pt' : ''" :href="beneficiaries.linkInfoPage"> {{beneficiaries.linkInfoPage}} </a>**</h6>
		...
		<h6 :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; margin-top: 5rem; text-align: justify; margin-bottom: 20px;">Կից ներկայացվում է հրավերին կցված նախագծային փաստաթղթերով սահմանված տեխնիկական բնութագրերին համապատասխանող սարքերի և սարքավորումների տեխնիկական բնութագրերը, ապրանքային նշանները, ֆիրմային անվանումները, մակնիշները, արտադրողները և երաշխիքային ժամկետները:</h6>
		...
		<pagebreak/>
		<div class="info-block" v-if="isWithProductsDetails">
			...
			<h6 :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; text-align: right; font-weight: 700">« <span :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{ password }}</span> »  ծածկագրով</h6>
			<h6 :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; text-align: right; font-weight: 700"><span :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{getTenderTypeByPlan}}</span> հրավերի</h6>
			<h6 :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; text-align: center; font-weight: 700; margin-top: 2rem">ՆԿԱՐԱԳԻՐ</h6>
			<h6 :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; text-align: center; font-weight: 700">սարքերի և սարքավորումների</h6>
			<h6 :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; margin-bottom: 1rem; text-align: justify;">« <span :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{ participantInfo.name.hy }}</span> » <span :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{ participantInfo.company_type.hy }}</span>-ն « <span :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{ password }}</span> » ծածկագրով <span :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{getTenderTypeByPlan}}</span> շրջանակում ըստ չափաբաժինների ստորև ներկայացնում է իր կողմից առաջարկվող ապրանքի ամբողջական նկարագիրը</h6>
			<table style=" font-size: 14px; font-family: GHEA grapalat ; 		width: 100%;
								table-layout: fixed;
								border-collapse: collapse;
								page-break-inside: avoid;
		...
		<div v-if="isWithArmenianResources" class="info-block">
			<h6 :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; text-align: right; font-weight: 700">Հավելված 1.2</h6>
			<h6 :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; text-align: right; font-weight: 700">« <span :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{ password }}</span> »  ծածկագրով</h6>
			<h6 :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; text-align: right; font-weight: 700"><span :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{getTenderTypeByPlan}}</span> հրավերի</h6>
			...
			<h6 :style="newProps ? 'font-size: 11pt' : ''" style="font-family: GHEA grapalat ;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; այդ չափաբաժինների մասով կնքվելիք պայմանագիրը կատարելու ժամանակ գնային առաջարկով ներկայացվող արժեքի ավելի քան 50 տոկոսը՝ հանրագումարային ձևով, ուղղել հայաստանյան ծագում ունեցող աշխատանքային և (կամ) արտադրական ռեսուրսների օգտագործման միջոցով պայմանագրի կատարմանը,</h6>
			<h6 :style="newProps ? 'font-size: 11pt' : ''" style="font-family: GHEA grapalat ;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; պայմանագիրը կատարել  թվով <span :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{ workersCount }}</span> աշխատակիցների միջոցով։</h6>
			<h6 :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; margin-top: 2rem">Ստորև ներկայացվում է աշխատանքի ընթացքում օգտագործվելիք նյութերի ցանկը՝ </h6>
			<table style=" font-size: 14px; font-family: GHEA grapalat ; 		width: 100%;
								table-layout: fixed;
								border-collapse: collapse;
								page-break-inside: avoid;
		...
		<div class="info-block">
			...
			<h6 :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; margin-top: 2rem; text-align: justify;">Ուսումնասիրելով « <span :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{ password }}</span> » ծածկագրով <span :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{getTenderTypeByPlan}}</span> հրավերը, այդ թվում կնքվելիք  պայմանագրի նախագիծը, 
				...
				<thead>
					<tr>
						...
						<th :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; border: 1px solid  black;
									border-collapse: collapse;
									font-size: 12px;
									padding: 8px 18px;">Աշխատանքի անվանումը</th>
					...
					<tr v-for="(row, index) in rows" :key="index">
						...
						<template v-if="is_old">
							<td :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ;  border: 1px solid  black;
									...
									text-align: center;
									padding: 7px 7px;
									font-size: 14px;"><span :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{ row.cost }}</span> / <span style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{ fixIncorrectWords(row.valueWord) }}</span> /</td>
							<td :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ;  border: 1px solid  black;
									border-collapse: collapse;
									text-align: center;
									padding: 7px 7px;
									font-size: 14px;"><span :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{ row.profit }}</span> / <span style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{ fixIncorrectWords(row.valueWord) }}</span> /</td>
						</template>
						<td :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ;  border: 1px solid  black;
									border-collapse: collapse;
									text-align: center;
									padding: 7px 7px;
									font-size: 14px;" v-else><span :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{ row.value }}</span> / <span style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{ fixIncorrectWords(row.valueWord) }}</span> /</td>
						<td :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ;  border: 1px solid  black;
									border-collapse: collapse;
									text-align: center;
									padding: 7px 7px;
									font-size: 14px;"><template v-if="row.vat"><span :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{ row.vat }}</span> / <span style=" font-size: 14px; font-family: GHEA grapalat ; " class="color">{{ fixIncorrectWords(row.vatWord) }}</span> /</template></td>
						<td :style="newProps ? 'font-size: 11pt' : ''" style=" font-size: 14px; font-family: GHEA grapalat ;  border: 1px solid  black;
									border-collapse: collapse;
									text-align: center;
									padding: 7px 7px;
