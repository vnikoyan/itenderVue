                ...
                <div class="d-inline-block tab-block">
                  <ul class="nav nav-tabs align-items-end suggestions-tab-mobile" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                      <a class="nav-link active" id="home-tab" data-toggle="tab" href="#active" @click.prevent="$router.push('/contractmanagement/orders/active')" role="tab" aria-controls="home" aria-selected="true">
                        Պատվիրված
                      </a>
                    </li>
                    <li class="nav-item" role="presentation">
                    ...
                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="contact-tab" data-toggle="tab" href="#canceled" @click.prevent="$router.push('/contractmanagement/orders/canceled')" role="tab" aria-controls="contact" aria-selected="false">
                        Չկատարված
                      </a>
                    </li>
                  </ul>
  ...
  export default {
    data() {
      return {
        ...
        columns: ['contract_code', 'provider_name', 'lots', 'total_price', 'status', 'invoice_details', 'docs'],
        options: {
          requestAdapter (data) {
            return {
